...
create table `smbms_address`(
	...
	`addressDesc` VARCHAR(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '收货地址',
...
create table `smbms_bill`(
	`id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
	`billCode` VARCHAR(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '账单编号',
...
--修改字段-- 
-- alter TABLE `smbms_bill` CHANGE createBy createdBy BIGINT(20) DEFAULT NULL COMMENT '创建者(userId)';
-- alter TABLE `smbms_address` CHANGE createBy `createdBy` BIGINT(20) DEFAULT NULL COMMENT '创建者';
...
CREATE TABLE `smbms_provider`(
	...
	`proAddress` VARCHAR(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '收货地址',
